...
\def\mykeywords{Secret, Communications, Rot13, Cipher, Caesar, Clever key cipher, shift cipher, coursework report}
\def\myauthor{DS}
...
\begin{document}
	...
	\begin{abstract}
		...
		This is my report for web technologies course work
	\end{abstract}
